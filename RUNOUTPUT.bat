...
"C:\Users\Edward Bujack\AppData\Local\Programs\Python\Python35\Python.exe" --version
pause

REM Create output.txt for full capture of periodic print statements
python censusData.py > output.txt
